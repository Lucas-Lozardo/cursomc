...
@Entity
@Inheritance(strategy = InheritanceType.JOINED)			///MAPEAMENTO DA SUPERCLASSE (HERANCA) COM STRATEGY DE TABELAS SEPARADAS.
public abstract class Pagamento implements Serializable{  ///ABSTRACT PARA NAO PODER INSTANCIAR DIRETAMENTE A CLASSE MAS SIM A SUBCLASSE
